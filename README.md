...
We introduce `MuseTalk`, a **real-time high quality** lip-syncing model (30fps+ on an NVIDIA T`esla V100). MuseTalk can be applied with input videos, e.g., generated by [MuseV](https://github.com/TMElyralab/MuseV), as a complete virtual human solution.
